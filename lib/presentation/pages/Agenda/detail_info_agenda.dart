...
class _DetailInfoAGendaState extends State<DetailInfoAGenda> {
  ...
  void _alertDialog2(BuildContext context) async {
    final result = await showDialog(
        context: context,
        builder: (context) => BlocBuilder<AgendaDetailCubit, AgendaDetailState>(
              builder: (context, agendaDetailState) {
                return Card(
                  ...
                  margin: const EdgeInsets.only(
                      top: 165, left: 30, right: 30, bottom: 322),
                  child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          const Padding(
                            ...
                            child: Text("Bukti Pengajuan Donor",
                          ...
                          Text("Annisa Tyas Wijaya", style: CustomStyle03()),
                          const SizedBox(
                            height: 14,
                          ),
                      ...
                      children: [
                        ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                              ...
                              padding:
                                  const EdgeInsets.fromLTRB(88, 12, 88, 12)),
