...
import 'package:donor_darah/presentation/pages/stok_darah/screen_udd.dart';
...
import '../pages/jadwal_donor/daftar_umum.dart';
import '../pages/jadwal_donor/detail_jadwal_donor.dart';
import '../pages/udd/udd.dart';
...
final GoRouter router = GoRouter(
  ...
  routes: [
    ...
    GoRoute(
        path: "/udd2",
        name: Routes.screenudd,
        builder: (context, state) => const ScreenUDD()),
    GoRoute(
        path: "/stokdarah",
    ...
    GoRoute(
      ...
      builder: (context, state) => const ScreenDasboard(),
    ),
    GoRoute(
      path: '/login',
    ...
    GoRoute(
      ...
      builder: (context, state) {
        String alamat = state.extra as String;
    ...
    GoRoute(
      path: '/udd3',
      name: Routes.jadwalDonor,
      builder: (context, state) => const UddJadwalDonor(),
    ),
    GoRoute(
      path: '/detailjadwal',
      name: Routes.detailJadwalDonor,
      builder: (context, state) => const DetailJadwalDonor(),
    ),
    GoRoute(
      path: '/umum',
      name: Routes.daftarumum,
      builder: (context, state) => const DaftarUmum(),
    ),
  ],
);
